...
public class SortObjectByGenericWay {
  ...
  public static void main(String[] args) {
    ...
    Stream<Employee> sortedEmployees = sortGeneric(employees, (e1, e2) -> e2.getAge() - e1.getAge());
  ...
  private static <T> Stream<T> sortGeneric(List<T> t, Comparator<T> c) {
    return t.stream().sorted(c);
  }
